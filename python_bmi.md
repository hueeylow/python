...
It's time to test out the coding. After clicking 'Run Module' to execute the program, IDLE Shell 3.11.5 test environment will prompt for user's input susbequently (name, height, weight), and thereafter return results of the calculated BMI and remarks on the health status. <br>
